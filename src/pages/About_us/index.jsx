...
const AboutUsContainer = styled.div`
    ...
    width: 100%;
`
const ToggleContentsContainer = styled.div`
    display: flex;
    flex-direction: column;
    width: 100%;
    margin-top: 20px;
